    ...
    <div className="min-h-screen">
      ...
      <section
        className="relative text-white overflow-hidden py-24 lg:py-32
                   bg-[url('https://images.unsplash.com/photo-1596041695507-6c2e3c7c2e0b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center"
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Toko Mitra Kami</h1> {/* Diubah dari "Marketplace Berkelanjutan" */}
